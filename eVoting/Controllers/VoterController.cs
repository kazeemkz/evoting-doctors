...
namespace eVoting.Controllers
{
    ...
    public class VoterController : Controller
    {
        ...
        [HttpPost]
        // [HttpPost]
        public ActionResult Delete(Voter model)
        // public ActionResult DeleteAll()
        {
            try
            {
                ...
                foreach (Voter voter in allVoters)
                {
                    ...
                    //if (Membership.GetUser(voter.IdentityNumber) != null && voter.IdentityNumber != "kazeem" && voter.IdentityNumber != "password" && voter.IdentityNumber != "chair")
                    //{
                    //    Membership.DeleteUser(theRealVoter.IdentityNumber, true);
                    //}
                 //   List<Voter> allVoterss = work.VoterRepository.Get(a => a.IdentityNumber == "chair").ToList();

                    //foreach (Voter v in allVoters)
                    //{
                    //    if(allVoterss.Count)
                    //}
                }
